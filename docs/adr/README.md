...
Architecture Decision Records capture significant technical choices for FastRep API. Accepted records describe decisions currently in use. Proposed records describe direction that has not been implemented.

| ADR                                             | Status   | Decision                                    |
| ----------------------------------------------- | -------- | ------------------------------------------- |
| [001](001-use-nestjs-modular-monolith.md)       | Accepted | Use a NestJS modular monolith.              |
